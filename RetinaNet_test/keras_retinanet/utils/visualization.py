...
def draw_caption(image, box, caption,color=(0,0,255)):
    ...
    text_thickness = 1
    thickness = 2
    text_size, baseline = cv2.getTextSize(caption, font, scale, text_thickness)
    b1 = (b[0] - text_size[1], b[1] - 10)

    cv2.rectangle(image, (b1[0] + thickness*9, b1[1]-baseline-thickness*9), (b1[0] + thickness*30 + text_size[0], b1[1] + text_size[1] - baseline), color, -1)
    cv2.putText(image, caption, (b[0], b[1] - 10), font, 1, (255, 255, 255), 2)
    # cv2.putText(image, caption, (b[0], b[1] - 10), font, 1, (255, 255, 255), 1)
...
def draw_annotations(image, annotations, color=(0, 255, 0), label_to_name=None):
    ...
    for i in range(annotations['bboxes'].shape[0]):
        ...
        draw_caption(image, annotations['bboxes'][i], caption,color=c)
